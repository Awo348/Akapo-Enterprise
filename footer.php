                    ...
                    <div class="footer-items">
                        ...
                        <ul class="social-icons list-inline pt-2">
                            ...
                            while ($ro = mysqli_fetch_array($r123)) {
                                ...
                                print "
<li class='list-inline-item px-1'><a href='$social_link' target='_blank'><i class='fab $fa'></i></a></li>
";
                            }
                            ?>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="copyright-area d-flex flex-wrap justify-content-center justify-content-sm-between text-center py-4">
                        ...
                        <!-- Copyright Right -->
                        <div class="copyright-right">Made with <i class="fas fa-heart"></i> By <a href="https://facebook.com/hillsoftsnetwork">Harwo </a></div>
                    </div>
                </div>
            </div>
        </div>
