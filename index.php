        ...
        <div class="row align-items-center">
            ...
            <div class="col-12 col-md-7">
                ...
                <div class="welcome-intro">
                    <h1 class="text-white" style="text-transform: capitalize; font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif;"><?php print $stitle ?></h1>
...
<div class='single-promo color-1 bg-hover hover-bottom text-center p-5'>
    <h3 class='mb-3' style='font-size: 40px; text-transform: capitalize; font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif;'>$title</h3>
    <p>$detail</p>
</div>
</div>
";
        ...
        <div class="row justify-content-center">
            <div class="col-12 col-md-10 col-lg-7">
                ...
                <div class="section-heading text-center">
                    <h2 style="text-transform: capitalize; font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif;"><?php print $service_title ?></h2>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-12 col-md-10 col-lg-7">
                <!-- Section Heading -->
                <div class="section-heading text-center">
                    <h2 style="text-transform: capitalize; font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif;"><?php print $port_title ?></h2>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-12 col-md-10 col-lg-7">
                ...
                <div class="section-heading text-center">
                    <h2 class="text-white" style="text-transform: capitalize; font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif;"><?php print $test_title; ?></h2>
        ...
        <div class="row justify-content-between align-items-center">
            <div class="col-12 col-lg-5">
                ...
                <div class="section-heading text-center mb-3">
                    <h2 style="text-transform: capitalize; font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif;"><?php print $contact_title ?></h2>
                    <p class="d-none d-sm-block mt-4" style="text-transform: capitalize; font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif;"><?php print $contact_text ?></p>
                </div>
                <!-- Contact Us -->
                    ...
                    <ul>
                        ...
                        <li class="contact-info color-1 bg-hover active hover-bottom text-center p-5 m-3">
                            ...
                            <a class="d-block my-2" href="tel:<?php print $phone1 ?>">
                                <h3 style="text-transform: capitalize; font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif;"><?php print $phone1 ?></h3>
                            </a>
                        ...
                        <li class="contact-info color-3 bg-hover active hover-bottom text-center p-5 m-3">
                            ...
                            <a class="d-none d-sm-block my-2" href="mailto:<?php print $email1 ?>">
                                <h3 style="text-transform: capitalize; font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif;"><?php print $email1 ?></h3>
                            </a>
        ...
        <div class="row justify-content-center">
            <div class="col-12 col-lg-10">
                ...
                <div class="section-heading text-center m-0">
                    <h2 class="text-white" style="text-transform: capitalize; font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif;"><?php print $enquiry_title; ?></h2>
